...
public class PictureService {
    // This might be slightly buggy, needs more review
    private final Path directory = Paths.get(System.getProperty("user.dir"), "Profile-pictures");
    private String fileExt(String s) { // returns file extention
    ...
    public String saveImage(MultipartFile file) {
        try {
            String fileName = UUID.randomUUID().toString() + fileExt(file.getOriginalFilename()); // all the images names must be different
